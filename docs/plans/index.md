...
| 문서 | 우선순위 | 상태 | 요약 |
|---|---|---|---|
| [v2-05-session-model.md](v2-05-session-model.md) | P1 | in_progress | v2 세션 모델: in-store 논리 트리(Session messages+head, parent_id 실사용), /branches·/checkout 분기 탐색. 저장 포맷 StoredSession(레거시 폴백). run_round 무변경, 신규 의존성 0 |
