...
| [v1-04-persistence.md](v1-04-persistence.md) | P1 | draft | 전사 영속(StoredMessage id/parent 트리-ready + JSON save/load) + Session resume + main 상태파일 인자. 브랜치 feat/v1-store |
