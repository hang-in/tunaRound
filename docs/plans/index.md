...
| 문서 | 우선순위 | 상태 | 요약 |
|---|---|---|---|
| [v2-07-bounded-debate.md](v2-07-bounded-debate.md) | P1 | in_progress | v2 바운드 자동 교환: `/debate <n> <주제>`로 사람 발화 1회 -> 에이전트 N턴 자동 교환 -> 복귀. run_round N회 재사용, 최대 10 clamp. 트리거 UX 명확화 |
